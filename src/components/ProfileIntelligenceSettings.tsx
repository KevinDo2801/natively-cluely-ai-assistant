...
export function ProfileIntelligenceSettings({
    ...
    const renderIdentity = () => {
        const isActive = profileStatus.profileMode;
        const isDisabled = !profileStatus.hasProfile;
        return (
        <>
            ...
            >
                ...
                <button
                    type="button"
                    role="switch"
                    data-on={String(!!profileStatus.profileMode)}
                    aria-checked={!!profileStatus.profileMode}
                    aria-disabled={!profileStatus.hasProfile ? true : undefined}
